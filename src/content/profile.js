// Datos personales. Edita SOLO este bloque para personalizar el portafolio.
export const profile = {
  ...
  email: "gcrhistian.456@gmail.com",
  // Formato internacional sin "+", solo dígitos. Deducido de tu celular en memoria.
  whatsapp: "51973781181",
  github: "https://github.com/gcondezoy",

  // Frase de valor del hero (máx ~2 líneas).
...
// Logos reales vía Simple Icons (se tiñen de color con la ruta /_/f3f1ea).
export const stack = [
